...
const processOptions = async (options) => {
    const { logger = logger_1.defaultLogger, concurrency = config_1.CONCURRENT_JOBS } = options;
...
exports.runOnce = async (options) => {
    ...
    for (let i = 0; i < concurrency; i++) {
        promises.push(withPgClient(client => main_1.runTaskListOnce(taskList, client, options)));
    }
